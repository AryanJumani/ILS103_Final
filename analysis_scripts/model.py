...
def main():
    ...
    antutu_soc_path = '../raw_data/Antutu/Android_SoC.csv'
    antutu_ai_path = '../raw_data/Antutu/Android_AI_General.csv'
    deepen_latency_path = '../raw_data/DeepEn/Kernel_latency/conv-bn-relu_latency.json'
